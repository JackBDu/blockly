...
/**
 * @fileoverview p5dotjs for Blockly's Code demo.
...
/**
 * Load the Prettify CSS and p5dotjs.
 */
...
Code.renderContent = function() {
  ...
  if (content.id == 'content_xml') {
    ...
    xmlTextarea.focus();
  } else if (content.id == 'content_p5dotjs') {
...
Code.initLanguage = function() {
  ...
  var categories = ['catLogic', 'catEnvironment', 'catShapes', 'catStructures', 'catRenderings', 'catLoops', 'catMath', 'catText',
                    'catColour', 'catVariables'];
