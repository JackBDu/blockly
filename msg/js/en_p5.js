...
Blockly.Msg.INPUTS_DATE_HELPURL = "http://p5js.org/reference/#/p5/day";
Blockly.Msg.INPUTS_DATE_TOOLTIP_YEAR = "Returns the current year as an integer (2014, 2015, 2016, etc)";
Blockly.Msg.INPUTS_DATE_TOOLTIP_MONTH = "Returns the current month as a value from 1 - 12";
Blockly.Msg.INPUTS_DATE_TOOLTIP_DAY = "Returns the current day as a value from 1 - 31";
Blockly.Msg.INPUTS_DATE_TOOLTIP_HOUR = "Returns the current hour as a value from 0 - 23";
Blockly.Msg.INPUTS_DATE_TOOLTIP_MINUTE = "Returns the current minute as a value from 0 - 59";
Blockly.Msg.INPUTS_DATE_TOOLTIP_SECOND = "Returns the current second as a value from 0 - 59";
Blockly.Msg.INPUTS_MILLIS_HELPURL = "http://p5js.org/reference/#/p5/millis";
Blockly.Msg.INPUTS_MILLIS_TOOLTIP = "Returns the number of milliseconds since starting the program";
...
Blockly.Msg.SHAPES_RECT_HELPURL = "http://p5js.org/reference/#/p5/rect";
Blockly.Msg.SHAPES_RECT_TITLE = "draw rectangle";
Blockly.Msg.SHAPES_RECT_TOOLTIP = "Draws a rectangle to the screen";
...
Blockly.Msg.COLOUR_BACKGROUND_TITLE = 'set background color';
Blockly.Msg.COLOUR_BACKGROUND_TOOLTIP = 'Sets the color used for the background of the p5.js canvas';
Blockly.Msg.COLOUR_FILL_HELPURL = 'http://p5js.org/reference/#/p5/fill';
Blockly.Msg.COLOUR_FILL_TITLE = 'set fill color';
Blockly.Msg.COLOUR_FILL_TOOLTIP = 'Sets the color used to draw lines and borders around shapes';
Blockly.Msg.COLOUR_NOFILL_HELPURL = 'http://p5js.org/reference/#/p5/noFill';
Blockly.Msg.COLOUR_NOFILL_TITLE = 'no fill color';
Blockly.Msg.COLOUR_NOFILL_TOOLTIP = 'Disables filling geometry';
Blockly.Msg.COLOUR_NOSTROKE_HELPURL = 'http://p5js.org/reference/#/p5/noStroke';
Blockly.Msg.COLOUR_NOSTROKE_TITLE = 'no stroke color';
Blockly.Msg.COLOUR_NOSTROKE_TOOLTIP = 'Disables drawing the stroke (outline)';
Blockly.Msg.COLOUR_PICKER_HELPURL = "https://en.wikipedia.org/wiki/Color";
Blockly.Msg.COLOUR_PICKER_TOOLTIP = "Choose a colour from the palette.";
Blockly.Msg.COLOUR_STROKE_HELPURL = 'http://p5js.org/reference/#/p5/stroke';
Blockly.Msg.COLOUR_STROKE_TITLE = 'set stroke color';
Blockly.Msg.COLOUR_STROKE_TOOLTIP = 'Sets the color used to fill shapes';
...
Blockly.Msg.ENVIRONMENT_DISPLAY_OPERATOR_TOOLTIP_HEIGHT = "System variable that stores the height of the entire screen display";
Blockly.Msg.ENVIRONMENT_DISPLAY_OPERATOR_WIDTH = "width";
Blockly.Msg.ENVIRONMENT_DISPLAY_OPERATOR_HEIGHT = "height";
Blockly.Msg.ENVIRONMENT_WINDOW_TITLE = "window";
Blockly.Msg.ENVIRONMENT_WINDOW_HELPURL = "http://p5js.org/reference/#/p5/windowWidth";
Blockly.Msg.ENVIRONMENT_WINDOW_OPERATOR_TOOLTIP_WIDTH = "System variable that stores the width of the inner window";
Blockly.Msg.ENVIRONMENT_WINDOW_OPERATOR_TOOLTIP_HEIGHT = "System variable that stores the height of the inner window";
Blockly.Msg.ENVIRONMENT_WINDOW_OPERATOR_WIDTH = "width";
Blockly.Msg.ENVIRONMENT_WINDOW_OPERATOR_HEIGHT = "height";
Blockly.Msg.ENVIRONMENT_CANVAS_TITLE = "canvas";
Blockly.Msg.ENVIRONMENT_CANVAS_HELPURL = "http://p5js.org/reference/#/p5/width";
Blockly.Msg.ENVIRONMENT_CANVAS_OPERATOR_TOOLTIP_WIDTH = "System variable that stores the width of the drawing canvas";
...
Blockly.Msg.MATH_THREE_NUMBER_TOOLTIP = "Represents three numbers (a, b, c)";
Blockly.Msg.MATH_THREE_NUMBER_COMMA = ",";
...
Blockly.Msg.STRUCTURES_LOOP_HELPURL = "http://p5js.org/reference/#/p5/loop";
Blockly.Msg.STRUCTURES_LOOP_OPERATOR_OFF = "off";
Blockly.Msg.STRUCTURES_LOOP_OPERATOR_ON = "on";
Blockly.Msg.STRUCTURES_LOOP_TITLE = "loop";
Blockly.Msg.STRUCTURES_LOOP_TOOLTIP_OFF = "Stop p5.js from continuously executing the code within draw()";
Blockly.Msg.STRUCTURES_LOOP_TOOLTIP_ON = "Resumes draw() loop stopped by noLoop()";
Blockly.Msg.STRUCTURES_PRELOAD_HELPURL = "http://p5js.org/reference/#/p5/preload";
Blockly.Msg.STRUCTURES_PRELOAD_TITLE = "preload";
Blockly.Msg.STRUCTURES_PRELOAD_TOOLTIP = "Called directly before setup()";
Blockly.Msg.STRUCTURES_PUSHPOP_HELPURL = "http://p5js.org/reference/#/p5/push";
Blockly.Msg.STRUCTURES_PUSHPOP_OPERATOR_POP = "pop";
Blockly.Msg.STRUCTURES_PUSHPOP_OPERATOR_PUSH = "push";
Blockly.Msg.STRUCTURES_PUSHPOP_TITLE = "settings";
Blockly.Msg.STRUCTURES_PUSHPOP_TOOLTIP_POP = "Restores the drawing style settings and transformations";
Blockly.Msg.STRUCTURES_PUSHPOP_TOOLTIP_PUSH = "Saves the current drawing style settings and transformations";
Blockly.Msg.STRUCTURES_REDRAW_HELPURL = "http://p5js.org/reference/#/p5/redraw";
Blockly.Msg.STRUCTURES_REDRAW_TITLE = "redraw";
Blockly.Msg.STRUCTURES_REDRAW_TOOLTIP = "Executes the code within draw() one time";
Blockly.Msg.STRUCTURES_REMOVE_HELPURL = "http://p5js.org/reference/#/p5/remove";
Blockly.Msg.STRUCTURES_REMOVE_TITLE = "remove";
Blockly.Msg.STRUCTURES_REMOVE_TOOLTIP = "Removes the entire p5 sketch";
Blockly.Msg.STRUCTURES_SETUP_HELPURL = "http://p5js.org/reference/#/p5/setup";
Blockly.Msg.STRUCTURES_SETUP_TITLE = "setup";
Blockly.Msg.STRUCTURES_SETUP_TOOLTIP = "Called once when the program starts";
