...
Blockly.Msg.RENDERINGS_DRAW_TITLE = "draw";
Blockly.Msg.RENDERINGS_DRAW_HELPURL = "http://p5js.org/reference/#/p5/draw";
Blockly.Msg.RENDERINGS_DRAW_TOOLTIP = "Called directly after setup()";
Blockly.Msg.RENDERINGS_REMOVE_HELPURL = "http://p5js.org/reference/#/p5/remove";
Blockly.Msg.RENDERINGS_REMOVE_TITLE = "remove";
Blockly.Msg.RENDERINGS_REMOVE_TOOLTIP = "Removes the entire p5 sketch";
Blockly.Msg.RENDERINGS_LOOP_HELPURL = "http://p5js.org/reference/#/p5/loop";
Blockly.Msg.RENDERINGS_LOOP_TITLE = "loop";
Blockly.Msg.RENDERINGS_LOOP_OPERATOR_ON = "on";
Blockly.Msg.RENDERINGS_LOOP_OPERATOR_OFF = "off";
Blockly.Msg.RENDERINGS_LOOP_TOOLTIP_ON = "Resumes draw() loop stopped by noLoop()";
Blockly.Msg.RENDERINGS_LOOP_TOOLTIP_OFF = "Stop p5.js from continuously executing the code within draw()";
Blockly.Msg.RENDERINGS_PUSHPOP_HELPURL = "http://p5js.org/reference/#/p5/push";
Blockly.Msg.RENDERINGS_PUSHPOP_TITLE = "settings";
Blockly.Msg.RENDERINGS_PUSHPOP_OPERATOR_PUSH = "push";
Blockly.Msg.RENDERINGS_PUSHPOP_OPERATOR_POP = "pop";
Blockly.Msg.RENDERINGS_PUSHPOP_TOOLTIP_PUSH = "Saves the current drawing style settings and transformations";
Blockly.Msg.RENDERINGS_PUSHPOP_TOOLTIP_POP = "Restores the drawing style settings and transformations";
Blockly.Msg.RENDERINGS_REDRAW_HELPURL = "http://p5js.org/reference/#/p5/redraw";
Blockly.Msg.RENDERINGS_REDRAW_TITLE = "redraw";
Blockly.Msg.RENDERINGS_REDRAW_TOOLTIP = "Executes the code within draw() one time";
